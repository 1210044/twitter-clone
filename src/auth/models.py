...
class User(Base):
    ...
    user_followers = relationship('Follow', foreign_keys='Follow.following_id', back_populates='following')
    user_followings = relationship('Follow', foreign_keys='Follow.follower_id', back_populates='follower')
...
class Follow(Base):
    ...
    following = relationship('User', foreign_keys=[following_id], back_populates='user_followings')
    follower = relationship('User', foreign_keys=[follower_id], back_populates='user_followers')